...
//=========================================================
ParamToggle::ParamToggle() : aPtr(nullptr) {}

ParamToggle::ParamToggle(apvts& tree, const juce::String& paramID)
    : aPtr(std::make_unique<apvts::ButtonAttachment>(tree, paramID, *this)) {}

void ParamToggle::atttachToState(apvts& state, const juce::String& paramID) {
  aPtr.reset(new apvts::ButtonAttachment(state, paramID, *this));
}
